...
| 1.   | 15. 3. 2019 | 28. 3. 2019 | 📜{nbsp}link:files/1/1_task.ipynb[Měření nejkratší vzdálenosti obdélníků] | 5 (+2)
| 2.   | 29. 3. 2019 | 11. 4. 2019  | 📜{nbsp}Projektivní transformace     | 6 (+2)     

...
Úkoly nejsou povinné, *tvoří však přes polovinu možných bodů ze semestru* (26 bodů z celkových 50). Přípomínáme, že k získání zápočtu je nutné za cvičení získat *minimálně 25 bodů*, podrobnosti viz sekce link:../classification/index.adoc[hodnocení].
...
Úkoly budou ve stejném formátu jako probíhá práce na cvičení, tzn. Jupyter notebooky. Na domácím PC tedy doporučujeme nainstalovat multiplatformní Anacondu pro správu Python balíčku a vytvořit si virtuální prostředí viz link:../tutorials/files/1/course-tools-introduction.adoc[návod]. Pokud nemáte systém Win x64, tak se vám pravděpodobně nepodaří vytvořit prostředí pomocí link:../tutorials/files/1/spec-file.txt[spec-file] a budete muset balíčky nainstalovat ručně. Balíčky se instalují příkazem `conda install` viz link:../tutorials/files/1/course-tools-introduction.adoc[návod].

...
Úkoly odevzdávejte na FIT Gitlab. Vytvořte si *privátní repozitář* a přidejte do něj uživatele `@zitnyjak`, `@brchlluk`, `@malecada`, `@kasalpe1` a `@novakj67` s rolemi "reporter".

...
.5+| 6.
.5+| {d06}
| 🤖{nbsp}https://vitesco-technologies.com/en/[Vitesco Technologies]: 💬{nbsp}Industry 4.0 - strojové vidění v praxi
...
<| 🦾{nbsp}https://www.atg.cz[ATG]: 💬{nbsp}Strojové vidění v NDT (__video na YT po přihlášení přes google FIT účet__)

...
| 10.       | 3. 12. 2020  | 📖{nbsp}link:files/bi-svz-09-segmentace-obrazu-plosne.pdf[Segmentace obrazu - Houghova transformace a plošné segmentace] (link:https://gitlab.fit.cvut.cz/bi-svz/bi-svz/blob/master/lectures/files/Otsu.xlsx[Otsuova metoda])| 📼 

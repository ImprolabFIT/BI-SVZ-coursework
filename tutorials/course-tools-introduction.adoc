...
Aktuálně prosíme o otestování instalace prostředí pro Linux Ubuntu. Jeho instalaci najdete na GITu v repu BI-SVZ v separátní větvi __linux-env-spec-file__.

_mailto:jakub.novak@fit.cvut.cz[Jakub Novák], 19. 2. 2020_
====

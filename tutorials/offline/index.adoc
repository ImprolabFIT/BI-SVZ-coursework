...
Stručné základy Pythonu lze nalézt v notebooku link:../files/1/python-introduction.ipynb[python-introduction.ipynb]. Pro hlubší poznání existuje třeba kurz v češtině od https://naucse.python.cz/course/pyladies/[PyLadies]

...
==== Windows
Pro instalaci na Windows je nejlepší stáhnout si rovnou hotový instalátor z githubu https://github.com/UB-Mannheim/tesseract/wiki[UB Mannheim]. Aktuálně (17. 9. 2020) nejnovější je dostupná verze 5.0.0 alpha.

* Stáhnout si instalátor https://digi.bib.uni-mannheim.de/tesseract/tesseract-ocr-w64-setup-v5.0.0-alpha.20200328.exe[ZDE].

...
|   8.    | 23. 11. 2018 | Klasifikace obrazu, detekce objektů  | 📜{nbsp}link:files/8/object-classification.ipynb[Klasifikace{nbsp}objektů{nbsp}-{nbsp}tvarové{nbsp}charakteristiky]
💾{nbsp}link:https://github.com/matterport/Mask_RCNN[Mask-RCNN{nbsp}github{nbsp}repozitář{nbsp}]    |  2   

|   9.    | 30. 11. 2018 | Základy měření s termokamerou        |   📜{nbsp}link:files/9/face-detection.ipynb[Detekce{nbsp}obličeje{nbsp}pomoci{nbsp}termokamery] |  2   

|   10.   | 7. 12. 2018  | Řádkové kamery                       | 📜{nbsp}link:files/10/scratches-detection.ipynb[Detekce{nbsp}škrábanců{nbsp}na{nbsp}skle]    |  2   

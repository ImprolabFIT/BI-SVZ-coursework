...
|   6.    | 29. 3. 2019  | Perspektiva obrazu                   | 📜{nbsp}link:files/6/perspective-measuring-length.ipynb[Perspektiva{nbsp}-{nbsp}měření{nbsp}výšky],
📜{nbsp}link:files/6/perspective-measuring-height.ipynb[Perspektiva{nbsp}-{nbsp}měření{nbsp}vzdálenosti]  |  2
...
|   -     | 12. 4. 2019 | link:https://fit.cvut.cz/student/studijni/harmonogram/2018/ls[výuka odpadá]          |     | 

|   8.    | 19. 4. 2019 | Práce s hloubkovou kamerou           | 📜{nbsp}link:files/8/depth-collisions.ipynb[Hloubkové{nbsp}senzory{nbsp}-{nbsp}detekce{nbsp}kolizí]    |  2

...
📖{nbsp}link:../manuals/lab-equipment#[Zásady{nbsp}práce{nbsp}s{nbsp}vybavením],
📜{nbsp}link:files/1/jupyter-introduction#[Práce{nbsp}v{nbsp}Jupyter{nbsp}notebooku],
| 2

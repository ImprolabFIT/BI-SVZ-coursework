...
|   1.    | 22. 2. 2019  | Úvodní cvičení, seznámení s nástroji | 📖{nbsp}link:files/1/bi-svz-01-cviceni-uvod.pdf[Úvodní{nbsp}prezentace], 
...
|   2.    | 1. 3. 2019 | Práce v Jupyter notebooku        | |  2  

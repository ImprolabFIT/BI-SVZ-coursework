...
|   6.   | 12. 5. 2020  | Řádkové kamery                       | 📜{nbsp}link:files/6/scratches-detection.html[Detekce{nbsp}škrábanců{nbsp}na{nbsp}skle]    |  2

|   7.    | 27. 3. 2020  | Perspektiva obrazu                   | 📜{nbsp}link:files/7/perspective-measuring-length.html[Perspektiva{nbsp}-{nbsp}měření{nbsp}vzdálenosti],
📜{nbsp}link:files/7/perspective-measuring-height.html[Perspektiva{nbsp}-{nbsp}měření{nbsp}výšky]  |  2

|   8.    | 3. 4. 2020  | Pespektiva obrazu, 360° objektivy  | 📜{nbsp}link:files/8/perspective-cart-polar-system.html[Perspektiva{nbsp}-{nbsp}polární{nbsp}souřadný{nbsp}systém]    |  2

|   9.    | 17. 4. 2020 | Práce s hloubkovou kamerou           | 📜{nbsp}link:files/9/depth-collisions.html[Hloubkové{nbsp}senzory{nbsp}-{nbsp}detekce{nbsp}kolizí]    |  2
...
|   11.    | 24. 4. 2020 | Základy měření s termokamerou        |   📜{nbsp}link:files/11/face-detection.html[Detekce{nbsp}obličeje{nbsp}pomoci{nbsp}termokamery] |  2

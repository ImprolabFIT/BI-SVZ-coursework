...
== Práce s repozitářem
Práci s repozitářem lze rozdělit do několika kategorií podle toho, jak dlouhou dobu s ním již pracuji.
...
==== 
Typický příklad je, když si uživatel na cvičení doplnil jupyter notebook svými údaji a na repozitáři se zpětně v tom samém notebooku něco změnilo (například oprava překlepu). 

...
Okamžitě to nahlásím cvičícím. Pokud jsi náhodou viníkem závady Ty, je lepší nám to sdělit s předstihem, než se to dozvíme z bezpečnostní kamery v laboratoři.  Pokud to budeme řešit my zpětně bez nahlášení, vina padá automaticky na Tebe.

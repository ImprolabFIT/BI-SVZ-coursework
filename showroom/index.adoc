...
** Interaktivní demonstrace úpravy jasu a kontrastu, gamma korekce, ekvalizace histogramu a CLAHE. Slouží jako podpůrný materiál k přednášce - xref:../lectures/index.html[Předzpracování obrazu - Transformace a korekce].

...
NOTE: https://new.kos.cvut.cz/terms[Nový] webový KOS obsahuje všechny termíny přehledně na jedné straně - jak regulérní termíny, tak jednorázové akce.
...
* Internet *není* dostupný pro repozitář na deepnote, courses nebo fití gitlab.

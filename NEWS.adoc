...
.Organizace semestru
* Přednášky probíhají v úterý 9:15–10:45 v učebně JP:B-571, první přednáška je *22. 9. 2026*.
...
* Otázky teoretické části zkoušky budou během semestru upraveny a rozšířeny, aby byly jednoznačné.
...
.Tým předmětu
* Přednášky 1-4 v tomto semestru vede David Kramný, zbývající přednášky vede Marcel Jiřina.
* Tým cvičících posílil o Honzu Soukupa!
* Správce laboratoře a cvičící Justýna Nováková (dříve Frommová) vás bude učit pod novým jménem, na GitLabu se nic nemění, email zůstává zatím původní - v průběhu semestru bude změněn. 
